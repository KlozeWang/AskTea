...
### AMD Support ###
SLIME_DIR="${SLIME_DIR:-./}" # Default path if not set in environment
export SLIME_DIR
echo $SLIME_DIR

MODEL_DIR="${MODEL_DIR:-/mnt/xujiawang/swe/data}" # Default path if not set in environment
export MODEL_DIR
echo $MODEL_DIR

DATA_DIR="${DATA_DIR:-/mnt/xujiawang/swe/data}"  # Default path if not set in environment
export DATA_DIR
echo $DATA_DIR
